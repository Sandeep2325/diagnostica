...
class gosamplify(models.Model):
    ...
    couponcode=models.CharField(max_length=20,null=True,blank=True,verbose_name="Coupon Code")
    couponval=models.CharField(max_length=5,blank=True,null=True,verbose_name="Coupon Value(%)")
    price=models.CharField(max_length=15,null=True,blank=True,verbose_name="Price(₹)")
    paymenttype=models.CharField(max_length=15,null=True,blank=True,verbose_name="Payment Type")
